    ...
    <div class="container">
        ...
        <form  method="post" action="{{route('products.update',['id'=>$products->id])}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{$products->name}}" placeholder="name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ISBN" name="ISBN" value="{{$products->ISBN}}" placeholder="ISBN">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="category_id[]" id="category" class="form-control" multiple>
                    @foreach($categories as $category)
                        <option value="{{$category->id}}" {{$products->categories->contains('id',$category->id)? 'selected': ''}}>
                            {{$category->name}}
                        </option>
                    @endforeach
                </select>
